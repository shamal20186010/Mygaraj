                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    <div class="col">
                        <div class="card shadow-sm"style="width:420px;">
                            <a href='/Mygaraj.lk/Sources/productDetails.php'> <img src="Sources/uploads/<?php echo $row["productName"] ?>.jpg" style="height:350px;width: 418px;"></a>
                            <div class="card-body"> 
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="btn-group">
                                        <button type="button" class="btn btn-sm btn-outline-secondary" style="background-color: #cccccc;"onclick="location.href = '/Mygaraj.lk/Sources/productDetails.php'">Buy it Now</button>
                                        <button type="button" class="btn btn-sm btn-outline-secondary" style="background-color: #ffff66">Add to cart</button>
                                    </div>
